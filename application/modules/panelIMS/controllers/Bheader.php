...
class Bheader extends CI_Controller
{
    ...
    public function add(){
        ...
        $data['title']       ='Admin Panel';
        $data['judul']       ='Master';
        $data['sub_judul']   ='Add BHeader';
        $data['judul_menu']  ='Braja Marketindo';
        $data['nama_jln']    ='Jl.Lotus Timur, Jakasetia, Jawa Barat';
        $data['content']     ='bheader/bheader_form';
        $this->load->view('dashboard', $data);
    }
    ...
    /*    $config['upload_path']      = "./assets/imgartikel/";
        ...
        if ($this->upload->do_upload('userfile')) {
            ...
            $simpan = $this->Model_bheader->insertdata($data);
            if ($simpan) {
                $this->session->set_flashdata('info','Data Berhasil Disimpan!');
                redirect('panelIMS/bheader');
            } else {
    ...
    public function edit($id){
        ...
        $data['title']       ='Admin Panel';
        $data['judul']       ='Master';
        $data['sub_judul']   ='Edit BHeader';
        $data['judul_menu']  ='Braja Marketindo';
        $data['nama_jln']    ='Jl.Lotus Timur, Jakasetia, Jawa Barat';
        $data['content']     ='bheader/bheader_edit';
        $data['record']      = $this->Model_bheader->editbheader($id);
        $this->load->view('dashboard', $data);
    }
    ...
    /*    $config['upload_path']    = "./assets/imgartikel/";
        ...
        if ($this->upload->do_upload('userfile')) {
            ...
            $kontent        = $this->input->post('kontent');
            $tampil         = $this->input->post('tampil');
            $id_bheader     = $this->input->post('id_bheader');
            ...
            $update = $this->Model_bheader->updatedata($id_bheader,$data);
            if ($update) {
    ...
    public function delete($id){
        $delete = $this->Model_bheader->deletedata($id);
        if ($delete) {
