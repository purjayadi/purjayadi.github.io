...
?>
    ...
    <div class="page-container">
        ...
        <h2 style="margin-top:0px">Keyword Kota <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="idkey_kota" value="<?php echo $idkey_kota; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('keywordkota') ?>" class="btn btn-default">Cancel</a>
	</form>
</div>
</div>
<?php
