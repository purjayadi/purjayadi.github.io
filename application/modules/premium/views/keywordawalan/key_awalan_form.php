...
?>
    ...
    <div class="page-container">
        ...
        <h2 style="margin-top:0px">Keyword Awalan <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="idkey_awalan" value="<?php echo $idkey_awalan; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('premium/keywordawalan') ?>" class="btn btn-default">Cancel</a>
	</form>
</div>
</div>
<?php
